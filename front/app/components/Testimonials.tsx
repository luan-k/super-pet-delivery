                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 relative h-full gap-20 md:gap-10 xl:gap-20 mt-20 justify-items-center">
                    ...
                    <div className="wk-testimonial">
                        ...
                        <div className="wk-testimonial__chat">
                            ...
                            <div className="wk-testimonial__text text-black text-center ">"Todo mundo que me conhece sabe que não gosto de motos, mas a moto do pessoal da <b>Super Pet Delivery</b> é <b>uma exceção</b>, já que depois da vinda deles ganho muita coisa boa dos meus humanos"</div>
                            <div className="wk-testimonial__author text-black text-right font-bold">Russo, 6 Anos</div>
                    ...
                    <div className="wk-testimonial">
                        ...
                        <div className="wk-testimonial__chat">
                            ...
                            <div className="wk-testimonial__text text-black text-center ">"Dizem que eu sou uma <b>Pet Rainha</b> e que só como e bebo do melhor! Meus humanos, por razões óbvias, escolheram a <b>Super Pet Delivery</b>, que é <b>simplesmente a melhor</b> da grande Florianópolis"</div>
                            <div className="wk-testimonial__author text-black text-right font-bold">Milady , 2 Anos</div>
