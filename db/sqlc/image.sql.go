...
INSERT INTO images (
    ...
    $1, $2
) RETURNING id, name, description, alt, path
`
...
func (q *Queries) CreateImage(ctx context.Context, arg CreateImageParams) (Image, error) {
	row := q.db.QueryRowContext(ctx, createImage, arg.Name, arg.Description)
	var i Image
	err := row.Scan(
		&i.ID,
		&i.Name,
...
SELECT id, name, description, alt, path FROM images 
WHERE id = $1 LIMIT 1
`
...
SELECT c.id, c.name, c.description, c.alt, c.path
FROM images c
...
func (q *Queries) UpdateImage(ctx context.Context, arg UpdateImageParams) (Image, error) {
	row := q.db.QueryRowContext(ctx, updateImage, arg.ID, arg.Name, arg.Description)
	var i Image
	err := row.Scan(
		&i.ID,
		&i.Name,
